...
-- current date. If true, set this date to be the current date. Format the output appropriately 
-- (YY-MM-DD).
...
INSERT INTO employees VALUES ('999999', '1989-10-10', 'Chris', 'Gallegos', 'M', '2022-12-31');
